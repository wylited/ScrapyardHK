    ...
    <div className="relative h-screen overflow-hidden rounded-b-3xl">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white mx-4">
        ...
        <div className="text-3xl md:text-4xl lg:text-5xl
                       ...
                       bg-clip-content
                       ">
          {t('The')} <span className="text-red-400 bg-slate-900 rounded-md shadow-lg p-1">{t('highschool hackathon')}</span> {t('where your wacky ideas become')} <span className="text-blue-400 bg-slate-900 rounded-md shadow-lg p-1">{t('wonderful inventions.')}</span>
        </div>
        ...
        <p className="text-2xl font-grotesk">March 15-16  @ <a href="https://maps.app.goo.gl/BRhV8SoBx5p19r6n6" className="underline hover:text-cyan-200" target="_blank">{t('HKPC Building')}</a></p>
      </div>
    </div>
  )
}
